# Source Catalog — Master Index

All tracked sources, sorted by overall score. Full rationale and metadata for each source lives in its category file. Scoring rubric: `../METHODOLOGY.md`. New/unscored sources: `candidates.md`.

| Score | Tier | Source | Category | Type |
|---|---|---|---|---|
| 4.6 | 1 | [KrebsOnSecurity](news-analysis.md#krebsonsecurity) | News & Analysis | Independent journalism |
| 4.4 | 1 | [CISA KEV Catalog](vulnerability-advisories.md#cisa-known-exploited-vulnerabilities-kev-catalog) | Vulnerability/Advisory | Government |
| 4.4 | 1 | [CISA Cybersecurity Advisories](vulnerability-advisories.md#cisa-cybersecurity-advisories-icsot-and-general) | Vulnerability/Advisory | Government |
| 4.4 | 1 | [Microsoft MSRC](vulnerability-advisories.md#microsoft-security-response-center-msrc--patch-tuesday--security-update-guide) | Vulnerability/Advisory | Vendor |
| 4.4 | 1 | [SANS ISC Handler's Diary](news-analysis.md#sans-internet-storm-center-isc-handlers-diary) | News & Analysis | Independent/practitioner |
| 4.2 | 1 | [NVD (NIST)](vulnerability-advisories.md#nvd-national-vulnerability-database--nist) | Vulnerability/Advisory | Government |
| 4.2 | 1 | [MITRE CVE Program](vulnerability-advisories.md#mitre-cve-program) | Vulnerability/Advisory | Government/standards |
| 4.2 | 1 | [OSV.dev](vulnerability-advisories.md#osvdev-open-source-vulnerabilities) | Vulnerability/Advisory, Open Source | Aggregator/standard |
...
| 3.6 | 2 | [SecurityWeek](threat-intel-research.md#securityweek) | Threat Intel | Trade press |
| 3.6 | 2 | [GHSA / GitHub Advisory Database](open-source-projects.md#ghsa--github-advisory-database) | Open Source | Aggregator |
| 3.4 | 2 | [Community KEV mirrors](open-source-projects.md#community-kev-mirrors-eg-cisagovkev-data-cryptogennepalcve-kev-rss) | Open Source, Vulnerability/Advisory | Community mirror |
